...
export OVSX_APP_PROFILE="${PROFILE_OUTPUT:-$PWD/src/dev/resources/application-ovsx.properties}"
...
echo "spring.datasource.password=${DATASOURCE_PASSWORD:-none}" >> $OVSX_APP_PROFILE
if [ -n "$DATASOURCE_PASSWORD" ]
then
    echo "datasource is enabled."
fi
